...
static const ERR_STRING_DATA ESNI_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_ESNI_BASE64_DECODE, 0), "esni_base64_decode"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_ESNI_CHECKSUM_CHECK, 0), "esni_checksum_check"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_ESNI_MAKE_RD, 0), "esni_make_rd"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_ESNI_MAKE_SE_FROM_ER, 0), "esni_make_se_from_er"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_KEY_DERIVATION, 0), "key_derivation"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_MAKEESNICONTENTHASH, 0), "makeesnicontenthash"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_NEW_FROM_BASE64, 0), "SSL_ESNI_RECORD_new_from_binary"},
    ...
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_SSL_ESNI_NEW_FROM_BASE64, 0), "SSL_ESNI_new_from_base64"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_SSL_ESNI_NEW_FROM_BUFFER, 0), "SSL_ESNI_new_from_buffer"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_SSL_ESNI_RECORD_NEW_FROM_BINARY, 0), "SSL_ESNI_RECORD_new_from_binary"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_SSL_ESNI_SERVER_ENABLE, 0), "SSL_esni_server_enable"},
    {ERR_PACK(ERR_LIB_ESNI, ESNI_F_SSL_ESNI_WRAP_KEYSHARE, 0), "SSL_ESNI_wrap_keyshare"},
    {0, NULL}
};

static const ERR_STRING_DATA ESNI_str_reasons[] = {
    {ERR_PACK(ERR_LIB_ESNI, 0, ESNI_R_BASE64_DECODE_ERROR), "base64 decode error"},
    {ERR_PACK(ERR_LIB_ESNI, 0, ESNI_R_ASCIIHEX_DECODE_ERROR), "ASCII hex decode error"},
    {ERR_PACK(ERR_LIB_ESNI, 0, ESNI_R_NOT_IMPL), "not implemented"},
    {ERR_PACK(ERR_LIB_ESNI, 0, ESNI_R_RR_DECODE_ERROR), "can't decode DNS resource record"},
    {0, NULL}
};
