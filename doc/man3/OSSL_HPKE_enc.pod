...
=head1 SYNOPSIS
 ...
 int OSSL_HPKE_suite_check(OSSL_LIB_CTX *libctx, hpke_suite_t suite);
 int OSSL_HPKE_str2suite(OSSL_LIB_CTX *libctx, char *str, hpke_suite_t suite);
 ...
 int OSSL_HPKE_prbuf2evp(OSSL_LIB_CTX *libctx, unsigned int kem_id, unsigned char *prbuf, size_t prbuf_len, unsigned char *pubuf, size_t pubuf_len, EVP_PKEY **priv);

 int OSSL_HPKE_enc(OSSL_LIB_CTX *libctx, unsigned int mode, hpke_suite_t suite, 
 ...
 int OSSL_HPKE_enc_evp(OSSL_LIB_CTX *libctx, unsigned int mode, hpke_suite_t suite, 
               char *pskid, size_t psklen, unsigned char *psk, 
               size_t publen, unsigned char *pub, 
               size_t authprivlen, unsigned char *authpriv, 
               EVP_PKEY *authpriv_evp,
 ...
 int OSSL_HPKE_dec(OSSL_LIB_CTX *libctx, unsigned int mode, hpke_suite_t suite, 
               char *pskid, size_t psklen, unsigned char *psk, 
 ...
 int OSSL_HPKE_expansion(OSSL_LIB_CTX *libctx, hpke_suite_t suite, size_t clearlen, size_t *cipherlen);
 int OSSL_HPKE_good4grease(OSSL_LIB_CTX *libctx,  hpke_suite_t *suite_in, hpke_suite_t suite, unsigned char *pub, size_t *pub_len, unsigned char *cipher, size_t cipher_len);
