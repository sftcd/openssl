...
The latest sorta-stable-ish code for that is in the [ECH-draft-13a](https://github.com/sftcd/openssl/tree/ECH-draft-13a)
branch, that interops with others and implements [esni-draft-13](https://datatracker.ietf.org/doc/html/draft-ietf-tls-esni-13). 
