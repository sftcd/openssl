...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_EARLY_DATA_COUNT_OK, 0),
     "early_data_count_ok"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_ESNI_SERVER_NAME_FIXUP, 0),
     "esni_server_name_fixup"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FINAL_ESNI, 0), "final_esni"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_ESNI, 0),
     "tls_construct_ctos_esni"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_ESNI, 0),
     "tls_parse_ctos_esni"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_ESNI, 0),
     "tls_parse_stoc_esni"},
